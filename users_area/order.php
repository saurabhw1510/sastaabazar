...
$total_price=0;
$cart_query_price="Select * from `card-details` where ip_address='$get_ip_address'";
...
//quantity
$get_cart="Select * from `card-details`";
...
$empty_cart="Delete from `card-details` where ip_address='$get_ip_address'";
