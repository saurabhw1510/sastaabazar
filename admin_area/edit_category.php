...
<div class="container mt-3">
    ...
    <form action="" method="post" class="text-center">
        <div class="form-outline mt-4 mb-4 w-50 m-auto">
            ...
            <input type="text" name="category_title" id="category_title" class="form_control" value='<?php echo $category_title;?>'>
        </div>
        <input type="submit" value="Update Category" class="btn btn-info px-3" name="edit_cat">
    </form>
</div>